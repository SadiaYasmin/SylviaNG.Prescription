...
{
    public class DeleteQuickAddPresetHandler : IRequestHandler<DeleteQuickAddPresetCommand, Unit>
    {
        ...
        public DeleteQuickAddPresetHandler(
        ...
        public async Task<Unit> Handle(DeleteQuickAddPresetCommand command, CancellationToken cancellationToken)
        {
            ...
            _quickAddPresetRepository.Delete(preset);
